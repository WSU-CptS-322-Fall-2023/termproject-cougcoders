...
class TestModels(unittest.TestCase):
    ...
    def test_get_students(self):
        ...
        test_student2 = Student(username='MB', email='M.B@wsu.edu', first_name='Matthew', last_name='Bruggeman', phone_number='1234',
                    wsu_id='1111', major='Cpts', gpa='4.0', graduation_date=datetime.utcnow(), user_type="Student")
        ...
        test_app = Application(reason='testing app', refrence_name='Sakire', refrence_email='S.AA@wsu.edu',
                               status='Pending', student_id=test_student.id, research_position_id=test_position.id)
        db.session.add(test_app)
        db.session.commit()
        test_app2 = Application(reason='testing app', refrence_name='Sakire', refrence_email='S.AA@wsu.edu',
                               status='Pending', student_id=test_student2.id, research_position_id=test_position.id)
